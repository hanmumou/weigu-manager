...
export const editGoods = (id,category_id,name,introduce,main_picture,detail_picture,video_url,price,original_price,cost_price,goods_sku_status,
...
export const delGoods = (goods_id_json) => post('api/goods/delete/destroy', {
  goods_id_json
})
...
//商品列表中  更新商品虚拟销量
export const updateVirtualNum = (id, num) =>GET('/api/goods/virtual-sales-num/'+id
 + '?virtual_sales_num=' + num
)

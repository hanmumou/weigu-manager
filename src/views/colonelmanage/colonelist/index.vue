    ...
    <div class="colonelmanage-container">
      ...
      <el-table id="#exportexcel" ref="multipleTable"
        ...
        <el-table-column label="操作" align="center" width="240">
          <template slot-scope="props">
            <el-button v-if="props.row.status===1" type="danger" size="small" @click="handlestatus(props.row)">关闭
            </el-button>
            <el-button v-if="props.row.status===0" type="success" size="small" @click="handlestatus(props.row)">开启
            </el-button>
      ...
      <!-- 分页 -->
      <div class="block">
        <el-pagination :total="total" :pager-count="5" :page-size="pagesize" background layout="prev, pager, next"

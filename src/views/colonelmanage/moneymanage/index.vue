          ...
          <el-table
            ...
            <el-table-column label="操作" align="center">
              <template slot-scope="scope">
                <el-button type="danger" size="mini" style="margin-bottom:5px;">手动发放</el-button>
                <el-button type="success" size="mini" style="margin-bottom:5px;">自动发放</el-button>
                <el-button type="infor" size="mini">不  发  放</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>

          ...
          <el-form :inline="true" class="demo-form-inline">
            ...
            <el-form-item label="消费状态：">
              <el-select placeholder="全部" value="">
                ...
                <el-option label="消费金额" value=""/>
                <el-option label="充值金额" value=""/>
                <el-option label="剩余金额" value=""/>
              </el-select>
          ...
          <el-table
            ...
            <el-table-column label="操作" align="center">
              <template slot-scope="scope">
                <el-button v-if="scope.row.status == 0" type="primary" size="small">启用</el-button>
                <el-button v-if="scope.row.status == 1" type="danger" size="small" >禁用</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>

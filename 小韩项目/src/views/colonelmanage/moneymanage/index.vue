  ...
  <div class="app-container">
    <el-tabs class="money-container" type="card">
      <el-tab-pane label="提现管理">
        ...
        <div>
          <el-table
            id="#exportexcel" :data="tableData3" border style="width: 100%" @selection-change="handleSelectionChange">
            <el-table-column type="selection" align="center"/>
            <el-table-column prop="name" label="团长ID" align="center"/>
            <el-table-column prop="name" label="团长姓名" align="center"/>
            <el-table-column prop="name" align="center"  label="团长电话"/>
            <el-table-column prop="phone" align="center" label="地区"/>
            <el-table-column prop="address" align="center" label="团长所在小区"/>
            <el-table-column prop="address" align="center" label="取货地址"/>
            <el-table-column prop="phone" align="center" label="总销售额"/>
            <el-table-column prop="phone" align="center" label="总提成"/>
            <el-table-column prop="phone" align="center" label="已提现"/>
            <el-table-column prop="phone" align="center" label="剩余提成"/>
            <el-table-column prop="phone" align="center" label="提现中"/>
            <el-table-column prop="phone" align="center" label="状态"/>
